...
class WithdrawDetails extends StatefulWidget {
  @override
  _WithdrawDetailsFormState createState() => _WithdrawDetailsFormState();
}

class _WithdrawDetailsFormState extends State<WithdrawDetails> {
  ...
  void _makeWithdrawRequest() async {
    ...
    final url = 'http://192.168.79.1:8000/api/withdraw/$username/';
